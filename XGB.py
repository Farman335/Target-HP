...
def initialize_and_train_xgboost(X_train, y_train, X_test, y_test):
    """
    Initializes an XGBoost Classifier with specified optimal hyperparameters
    ...
    """
    # Define the optimal hyperparameters as identified by grid search
    optimal_params = {
        'n_estimators': 200,
        'max_depth': 5,
        'learning_rate': 0.3,
        ...
        'eval_metric': 'logloss'    # Specify evaluation metric for binary classification
    }

    print("Initializing XGBoost Classifier with optimal hyperparameters:")
...
if __name__ == "__main__":
    ...
    # 2. Call the function to initialize and train the XGBoost model
    trained_model, predictions, probabilities = initialize_and_train_xgoost(
